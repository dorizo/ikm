        ...
        <div class="card rounded-3 border-0 bg-transparent">
          <div class="card-body">
              <div class="text-center error-img">
                <img src="<?=base_url("thames")?>/images/social-icons/check-mark.webp" width="80" alt="">
                <h5 class="text-dark mt-4 fw-bold">BERHASIL MENDAFTAR!</h5>
                <p class="mb-0">PENDAFTARAN AKUN BERHASIL</p>
              </div>
           </div>
          </div>
         </div>
     <!--end to page content-->
      ...
      <footer class="page-footer fixed-bottom border-top d-flex align-items-center px-0">
        ...
        <div class="filter-btn bg-dark w-100">
          <a href="<?=base_url("loginfrondend")?>" class="btn btn-ecomm p-0 text-white block-button">LOGIN</a>
        </div>
      </footer>
      <!--end to footer-->
